...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul style="background-color: darkblue" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Your Website 2022 developed by Onwell Gumbure</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
